/*The program is the solution of codeforces problem no. OPC MMNIT
Regn no.: 2025CA085
Program Date: 18-05-2026
Program Time: 09:50 IST    */
...
void solve() {
    ...
    for (int right = 1; right <= n; ++right) {
        left_boundary = max(left_boundary, max_left[right] + 1);
        total_ways += (right - left_boundary + 1);
    }
