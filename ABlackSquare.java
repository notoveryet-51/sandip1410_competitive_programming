/*The program is the solution of codeforces problem no. 431A
Regn no.: 2025CA085
Program Date: 10-06-2026
Program Time: 20:59 IST    */
...
public class ABlackSquare {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i=0; i<len; i++)  {
            if (s.charAt(i)=='1') sum+=a;
            else if (s.charAt(i)=='2') sum+=b;
            else if (s.charAt(i)=='3') sum+=c;
            else sum+=d;
        }
        out.print(sum);
        out.close();
