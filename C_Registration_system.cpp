/*The program is the solution of codeforces problem no. 4C
Regn no.: 2025CA085
Program Date: 26-06-2026
Program Time: 22:06 IST    */
...
/*----------------------------------SOLVE FUNCTION----------------------------------*/
void solve(unordered_map<string, ll> &mpp) {
    string s;  cin>>s;
    if (mpp.find(s)==mpp.end()) {
        cout<<"OK"<<endl;
    }
    else cout<<s+to_string(mpp[s])<<endl;
    mpp[s]++;
}
