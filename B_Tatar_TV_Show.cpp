/*The program is the solution of codeforces problem no. 2236B
Regn no.: 2025CA085
Program Date: 12-06-2026
Program Time: 20:18 IST    */
...
void solve() {
    ll n, k;    cin>>n>>k;
    string s;   cin>>s;
    unordered_map<ll, ll> countFreq;
    // freq of '1' positions with same remainders 
    for (ll i=0; i<n; i++) { 
        if (s[i]=='1') {
            countFreq[i%k]++;
        }
