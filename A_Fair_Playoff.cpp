/*The program is the solution of codeforces problem no. 1535A
Regn no.: 2025CA085
Program Date: 26-05-2026
Program Time: 16:26 IST    */
...
void solve() {
    ...
    vi sorted_s = s;
    sort(all(sorted_s));
    if ((winner1 == sorted_s[2] && winner2 == sorted_s[3]) || 
        (winner1 == sorted_s[3] && winner2 == sorted_s[2])) {
        yes();
    } else {
        no();
    }
