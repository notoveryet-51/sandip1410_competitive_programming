/*The program is the solution of codeforces problem no. 476A
Regn no.: 2025CA085
Program Date: 04-04-2026
Program Time: 17:03 IST    */
...
public class A_Dreamoon_and_Stairs {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //while (t-- > 0) {
            ...
            store=n/2;
            if (n%2==1) count=store+1;
            else count=store;
            while (count%m!=0 && store>0)   {
                store--;    count+=1;
            }
            if (count%m==0) System.out.println(count);
