/*The program is the solution of codeforces problem no. 2132A
Regn no.: 2025CA085
Program Date: 06-08-2026
Program Time: 19:41 IST    */
...
void solve() {
    ...
    string og;   cin>>og;
    ll m;   cin>>m;
    string str, turns;  cin>>str>>turns;
    for (ll i=0; i<m; i++) {
        if (turns[i]=='V') og=str[i]+og;
        else og+=str[i];
    }
    cout<<og<<endl;
}
