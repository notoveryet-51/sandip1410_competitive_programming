/*The program is the solution of codeforces problem no. 1182A
Regn no.: 2025CA085
Program Date: 05-05-2026
Program Time: 06:11 IST    */
...
public class AFillingShapes {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // }
        if (t>1 && t%2==0) System.out.println(1<<(t/2));
        else if (t<=1) System.out.println(0);
        else if (t%2!=0) System.out.println(0);   
