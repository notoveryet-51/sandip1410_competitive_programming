/*The program is the solution of codeforces problem no. 1690D
Regn no.: 2025CA085
Program Date: 05-04-2026
Program Time: 20:22 IST    */
...
void solve() {
    ll n, k;    cin>>n>>k;
    string s;   cin>>s;
    ll arr[n+1]={0};  ll count=0;
    for (ll i=0; i<n; i++)  {
        if (s[i] == 'W')    arr[i+1] = arr[i] + 1;
        else    arr[i+1] = arr[i];
    }
    ll mn=LLONG_MAX;
    for (ll i=0; i<=n-k; i++)  {
