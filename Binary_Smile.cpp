/*The program is the solution of codechef START240D problem no. D
Regn no.: 2025CA085
Program Date: 27-05-2026
Program Time: 20:39 IST    */
...
void solve() {
    ...
    if (sza(posA)==sza(posB)) {
        ll ans=0;
        for (ll i=0; i<sza(posA); i++) {
            if (posA[i]!=posB[i]) {
                ans++;
            }
        }
